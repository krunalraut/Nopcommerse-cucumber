...
public class RegisterPage extends Util {
    ...
    public void enterRegisterPageDetais()
    {
        ...
        //enter first name
        typeText(_FirstName,loadProp.getProperty("Name"),20);
        //enter Last name
        typeText(_LastName,loadProp.getProperty("Lastname"),20);
        //select day from list
        selectFromListByIndex(_DayDateOfBirth,3,20);
        //select month from list
        selectFromListByText(_MonthDateOfBirth,"April",10);
        //select month from list
        selectFromListByValue(_YearDateOfBirth,"1993",10);
        //enter email
        typeText(_Email,loadProp.getProperty("Name")+timestamp()+"@gmail.com",20);
        //click Newsletter
        clickOnElement(_NewsLetter,20);
        //enter company name
        typeText(_CompanyName,loadProp.getProperty("Company"),20);
        //enter password
        typeText(_Password,loadProp.getProperty("Password"),20);
        //enter confirm password
        typeText(_ConfirmPassword,loadProp.getProperty("Confirm_password"),20);
    }
